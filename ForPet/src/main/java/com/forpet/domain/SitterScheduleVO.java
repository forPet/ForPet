...
public class SitterScheduleVO {
	...
	private String oneSeven;
	private String oneEight;
	private String oneNine;
	private String twoZero;
	...
	public String getOneSeven() {
		return oneSeven;
	}

	public void setOneSeven(String oneSeven) {
		this.oneSeven = oneSeven;
	}

	public String getOneEight() {
		return oneEight;
	}

	public void setOneEight(String oneEight) {
		this.oneEight = oneEight;
	}
	...
	public String getTwoZero() {
		return twoZero;
	}

	public void setTwoZero(String twoZero) {
	...
	public String toString() {
		return "SitterScheduleVO [sitterNumber=" + sitterNumber + ", six=" + six + ", seven=" + seven + ", eight="
				+ eight + ", nine=" + nine + ", ten=" + ten + ", oneOne=" + oneOne + ", oneTwo=" + oneTwo
				+ ", oneThree=" + oneThree + ", oneFour=" + oneFour + ", oneFive=" + oneFive + ", oneSix=" + oneSix
				+ ", oneSeven=" + oneSeven + ", oneEight=" + oneEight + ", oneNine=" + oneNine + ", twoZero=" + twoZero
				+ ", twoOne=" + twoOne + ", twoTwo=" + twoTwo + ", twoThree=" + twoThree + "]";
	}
